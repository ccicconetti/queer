...
plot   '../data/out-10-100-constant.csv' u (int($15/25)*25):(1/10001.0) w lp smooth freq title "100 nodes",  '../data/out-10-50-constant.csv' u (int($15/25)*25):(1/10001.0) w lp smooth freq title "50 nodes"
#    EOF
