...
set key fixed top vertical Left noreverse enhanced autotitle nobox
...
set ylabel "Admission ratio" 
set ylabel  font "" textcolor lt -1 rotate
set y2label "Capacity used"
set y2label  font "" textcolor lt -1 rotate
set yrange [ 0.3 : 0.9 ] noreverse nowriteback
set y2range [ 0 : 0.3 ] noreverse nowriteback
set zlabel "" 
