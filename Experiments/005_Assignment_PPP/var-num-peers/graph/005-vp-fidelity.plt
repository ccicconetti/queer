...
set key bmargin horizontal center Right noreverse enhanced autotitle nobox
...
set xtics ("load balancing" 0.5, "random" 2.5, "shortest-path" 4.5, "load balancing" 7.5, "random" 9.5, "shortest-path" 11.5)
...
set xrange [ -.500000 : 12.50000 ] noreverse nowriteback
